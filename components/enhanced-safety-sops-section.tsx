...
export function EnhancedSafetySOPsSection() {
  return (
    <section className="py-20 px-4 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        {/* Canvas SOP Icons Row */}
        <div className="bg-white p-10 rounded-3xl shadow-xl mb-8">
          <h3 className="text-2xl font-bold text-ucsc-navy text-center mb-8">Equipment-Specific SOPs</h3>
          <p className="text-center text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
