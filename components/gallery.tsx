      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            See how students engage with our Canvas-integrated system and create
            amazing projects in the Slugworks makerspace.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600 mb-4">
            Want to see more of our student work and community activities?
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              onClick={() =>
                window.open(
                  "https://www.instagram.com/ucscslugworks/",
                  "_blank"
                )
              }
            >
            ...
            <button
              ...
              onClick={() =>
                window.open("https://canvas.ucsc.edu/courses/77701", "_blank")
              }
            >
